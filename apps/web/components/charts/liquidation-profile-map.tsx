...
function buildOption(model: Model): echarts.EChartsOption {
  ...
  return { animation: false, backgroundColor: "#070b12", grid: { left: 62, right: 62, top: 28, bottom: 64 }, tooltip: { trigger: "axis", confine: true, backgroundColor: "#080d14", borderColor: "#26364b", textStyle: { color: "#dce6f2", fontSize: 11 }, formatter: profileTooltip },
